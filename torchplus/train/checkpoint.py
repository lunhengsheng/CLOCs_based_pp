    ...
    with DelayedKeyboardInterrupt():
        ...
        if len(all_ckpts) > max_to_keep:
            if keep_latest:
                ...
                print("keep_latest, ckpt_to_delete: ", ckpt_to_delete)  # MX
            else:
                ...
                print("delete smallest step, ckpt_to_delete: ", ckpt_to_delete)  # MX
            print("Path(mode_dir)", str(Path(model_dir)))  # MX
            print("str(Path(model_dir) / ckpt_to_delete)", str(Path(model_dir) / ckpt_to_delete))  # MX
