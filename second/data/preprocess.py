...
def prep_pointcloud(input_dict,
    ...
    if training:
        ...
        #print("input_dict,2d:\n", input_dict["gt_2d_bbox"])        ###MX, KeyError. 没有这个key
    ...
    if training:
        ...
        """
        MX：这里数据增广，CLOCs中与SECOND相比与删掉了。增广的数据无法与2d检测器对应。
